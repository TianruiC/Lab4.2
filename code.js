...
var draw=function(data)
{
  ...
  dot.selectAll("circle")
     ...
     .attr("cy",function(d){return yScale(d.puppies);})
     .attr("r","5")
     .attr("fill",color("kittens"))
  ...
  legendLines.append("rect")
             ...
             .on("click",function(d){
               var line=d3.select("#"+d+"Area")
               var area=d3.select("#"+d+"Area")
               var toggledline=!line.classed("notshow")
               var toggledarea=!area.classed("notshow")
               line.classed("notshow",toggledline)
               area.classed("notshow",toggledarea)
             })
             .on("mouseover",function(d){d3.select("#"+d+"dot").classed("notshow",false)})
             .on("mouseout",function(d){d3.select("#"+d+"dot").classed("notshow",true)})
